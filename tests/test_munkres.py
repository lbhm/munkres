...
def test_20_x_20_float() -> None:
    ...
    matrix = [
        ...
        [10.0301, 9.0302, 4.0303, 6.0304, 9.0305, 5.0306, 3.0307, 7.0308, 10.0309, 1.031, 6.0311, 8, 1.0312, 1.0313, 10.0314, 9.0315, 5.0316, 7.0317, 7.0318, 5.0319],
...
def test_rectangular() -> None:
    ...
    padded_matrix = pad_matrix(np.asarray(matrix), 0)
